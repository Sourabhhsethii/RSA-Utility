...
import com.s8.rsa.util.Exponent;
import com.s8.rsa.util.Modulus;
...
public class RsaClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("java -cp RSA-Encryption-Decryption-1.0.jar com.s8.rsa.utility.RsaClient Encrypted-String");
