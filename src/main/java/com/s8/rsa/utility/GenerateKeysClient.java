...
import static com.s8.rsa.util.GenerateKeys.generateKey;
...
public class GenerateKeysClient {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println("java -cp RSA-Encryption-Decryption-1.0.jar com.s8.rsa.utility.GenerateKeysClient D:\\keypairs");
